...
| MVP-030 | MVP+ | UI/UX concept comparison and selected redesign direction | Partially implemented | PR #13; `docs/ui-concepts/mvp-021-ui-concepts.md` | Docs review and future selected-direction implementation tests | Three dashboard concepts are documented for review; no full runtime redesign is implemented until a direction is chosen. |
