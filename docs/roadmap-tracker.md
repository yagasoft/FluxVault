...
| Item id | Stage | Capability | Status | Implementation evidence | Verification evidence | Notes / next step |
| --- | --- | --- | --- | --- | --- | --- |
| V1-001 | V1 | Installer polish, service recovery, clean uninstall, upgrade/rollback | Partially implemented | This PR; `src/FluxVault.App/Services`; `src/FluxVault.App/ViewModels/MainWindowViewModel.cs`; `src/FluxVault.Service/Program.cs`; `src/FluxVault.Service/Worker.cs`; `src/FluxVault.Core/Service/FileSystemProtectionLoop.cs`; `eng/install-service.ps1`; `eng/uninstall-service.ps1` | `tests/FluxVault.App.Tests/MainWindowViewModelRefreshTests.cs`; `tests/FluxVault.App.Tests/XamlQualityTests.cs`; `tests/FluxVault.Integration.Tests/WorkerRecoveryTests.cs`; `tests/FluxVault.Integration.Tests/ProtectionLoopUsnTests.cs`; `tests/FluxVault.Integration.Tests/PackagingTests.cs` | Developer script hardening, dashboard service availability controls, Event Log wiring, and SCM restart recovery are implemented. Production installer technology, signing, upgrade packages, and rollback remain future work. |
