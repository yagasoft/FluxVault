...
| MVP-020 | MVP+ | Three-pane File browser selection UX | Planned | Roadmap PR #10 `0c72fd3`; `docs/roadmap.md`; `docs/requirements.md` | Planned tests in `docs/testing-strategy.md` | Next UI slice: replace Protection-tab browse/add workflow after implementation. |
