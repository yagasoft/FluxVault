...
public sealed class XamlQualityTests
{
    ...
    public void Diagnostics_tab_exposes_repository_health_dashboard_and_manual_maintenance_actions()
    {
        ...
        Assert.Contains(
            diagnosticsTab.Descendants(XamlNamespace + "TextBlock"),
            element => (string?)element.Attribute("Text") == "{Binding DeviceIdentityStatus}");
        Assert.Contains(
            diagnosticsTab.Descendants(XamlNamespace + "TextBlock"),
        ...
        Assert.Contains(
            diagnosticsTab.Descendants(XamlNamespace + "TextBlock"),
            element => (string?)element.Attribute("Text") == "{Binding PerformanceWorkspaceStatus}");
        Assert.Contains(
            diagnosticsTab.Descendants(XamlNamespace + "TextBlock"),
            element => (string?)element.Attribute("Text") == "{Binding ShellIntegrationStatus}");
        Assert.Contains(
            diagnosticsTab.Descendants(XamlNamespace + "TextBlock"),
